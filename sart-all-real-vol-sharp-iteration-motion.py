...
@njit(parallel=True)
def SART_prj_diff(prjbuf, prj_est, normprj):
    ...
    for beta in beta_array:
        ...
        for i in range(0, 5):
            ...
            for a in range(0, 5):
                ...
                # Get the projection data for the given angle
                ...
                ######################################################################		
                # Second and Third set of projections 
                for tr in range(2):
		            ...
		            angleStart,
		            angleEnd)
                    h_prj_est_sub    = h_prj_est_sub + d_prj_est_sub.copy_to_host()
                
                # Take mean of projections after 3 angles
